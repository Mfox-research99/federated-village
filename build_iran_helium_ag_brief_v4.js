...
bullet("The Intended Collapse of Speculative V: A 0.35% friction destroys the wafer-thin margins of High-Frequency Trading. Citadel executing ~$65T/year will not yield $227B in tax; their volume will collapse by 90%+. This is not a bug; it is the deliberate definancialization of the economy. The revenue models work even against a massively depressed V. The goal is to tax the path integral of money, dampening reflexive fragility."),
...
sp(80),
callout(
  "THE JURISDICTIONAL ARBITRAGE (EURODOLLAR) ANSWER",
  "If the US unilaterally taxes clearing, critics argue financial trades will offshore to Tokyo or London dark pools. The structural defense: The US Federal Reserve holds the ultimate chokepoint. Any global institution requiring access to the US discount window, US Treasury clearing, or Fedwire must agree to collect the flat rate on its global dollar books, regardless of jurisdiction. The exorbitant privilege of US clearing provides the compliance mechanism.",
  LGOLD, GOLD
),
sp(80),
callout(
...
sp(40),
actionBlock("6","Conditional Rebate \u2014 Productive Investment","30-Day Legislation","5\u201310% of velocity tax remitted by any entity \u2014 financial institution, manufacturer, agricultural company, hedge fund, or any other participant \u2014 is returned conditioned on deployment into tangible productive assets: manufacturing, infrastructure, agricultural capital, domestic helium recovery infrastructure, domestic ammonia production capacity, energy systems, housing. Participation requires a designated separate account, independent certification of deployment, and full audit trail. Criminal liability for misuse applies to every rebate recipient without exception. This is not a rate carve-out: every participant pays the full flat rate. The rebate channel is open to any entity willing to put capital to work in the real economy \u2014 with the same rules and the same liability for everyone."),
sp(40),
actionBlock("7","AI Monetary Management Authorization Act","90-Day Legislation","Authorize AI-managed dynamic rate adjustment operating on real-time clearing data, within parameters set by Congress and the Seventh Generation Oversight Commission. Rate formula: t(V) = t\u2080 + k \u00d7 max(0, V \u2212 V\u2080). Three-mode counter-cyclical design: Mode 1 (prosperity) builds reserves; Mode 2 (volatility) reduces friction; Mode 3 (crisis circuit breaker) applies a universal rate ceiling to all transactions \u2014 no transaction classification required, triggered by 2% de-dollarization or Fed systemic certification. Congressional override and financial sector exclusion from oversight are mandatory provisions. BIFURCATED AI ARCHITECTURE \u2014 MANDATORY: The system operates two legally distinct algorithmic layers. Layer 1 (Enforcement): tax calculation, transaction-level penalty execution, and rate application must use explicit, mathematically legible linear models only \u2014 opaque or black-box models are statutorily prohibited at this layer. Congress cannot authorize a penalty it cannot audit. Layer 2 (Analysis): macro-economic monitoring, supply chain anomaly detection, and the observational functions of the three-mode design may employ advanced non-linear models, including neural networks. Layer 2 systems are permanently cordoned from executing financial penalties and are subject to the same Seventh Generation constitutional audits as all other components of this Act. The Oversight Commission must certify the wall between layers before the system goes live. Any future legislation seeking to merge Layer 1 and Layer 2 functions requires a two-thirds vote of both chambers."),
sp(40),
...
Packer.toBuffer(doc).then(buf=>{
  const outPath = "/Users/michaeldavis/Michael Fox Politics/Dollar_Reserve_Protection_and_Supply_Chain_Security_Act_2026_v4.docx";
