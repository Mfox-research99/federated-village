...
new Table({width:{size:9720,type:WidthType.DXA},columnWidths:[9720],rows:[new TableRow({children:[new TableCell({borders:cb(NAVY),shading:{fill:NAVY,type:ShadingType.CLEAR},margins:{top:200,bottom:200,left:360,right:360},width:{size:9720,type:WidthType.DXA},children:[new Paragraph({alignment:AlignmentType.CENTER,children:[new TextRun({text:"EXEMPTION CREEP",color:GOLD,bold:true,size:26,font:"Arial"})]}),new Paragraph({alignment:AlignmentType.CENTER,spacing:{before:80},children:[new TextRun({text:"The entities facing a net tax increase \u2014 high-frequency traders, certain financial intermediaries \u2014 possess sophisticated lobbying power and will immediately seek carve-outs, volume thresholds, or rebates. Any exemption breaches the structural integrity of the system and invites a cascade of complexity that would recreate the very morass this reform seeks to replace.",color:WHITE,size:21,font:"Arial",italics:true})]}),new Paragraph({alignment:AlignmentType.CENTER,spacing:{before:80},children:[new TextRun({text:"Uniformity is the reform. Defending uniformity is defending everything.",color:GOLD,bold:true,size:22,font:"Arial"})]}),new Paragraph({alignment:AlignmentType.CENTER,spacing:{before:80},children:[new TextRun({text:"The federal government\u2019s own transactions are subject to this rate. State governments\u2019 transactions are subject to this rate. No entity \u2014 public or private \u2014 receives an exemption the US government itself does not receive. When the financial sector requests a carve-out, the answer is: explain why you deserve a privilege that Congress, the Pentagon, and the Treasury do not.",color:WHITE,size:21,font:"Arial",italics:true})]})]})]})]}),
